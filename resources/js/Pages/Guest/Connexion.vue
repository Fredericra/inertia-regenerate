<script setup>
    ...
    const connexion = computed(()=>{
        router.post(route('sotre.connexion'),form);
    })
</script>
<template>
    <div>
                    ...
                    <div classs="w-full px-20">
                        ...
                        <div class="border-2 border-indigo-950 rounded-b-2xl py-4 px-8">
                            <form @submit.prevent="connexion" class="space-y-3">
                                ...
                                <div class="py-2">
                                    <label for="">
                                        <input type="checkbox" name="" id=""> <span class="font-serif px-4 text-slate-500">j'accepter le condition</span>
                                    </label>
                                </div>
                                <div class="py-2 flex justify-between px-2 text-sm space-x-1">
                                    ...
                                    <div v-if="preg">
                                        <Link class="text-[12px] font-bold text-emerald-700 hover:text-indigo-700">mots de pass oublier</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
