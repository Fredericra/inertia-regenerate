...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        return array_merge(parent::share($request), [
            ...
            "plus"=>fn()=>Auth::check() && Auth::user()->email==="admin@dev1234"?Reponse::where("confirmed",false)->orderBy("id","desc")->get():null,
            "left"=>fn()=>Auth::check() && Auth::user()->email!=="admin@dev1234"?Reponse::with("admin")
